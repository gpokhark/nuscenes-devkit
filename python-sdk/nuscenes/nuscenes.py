...
class NuScenes:
    ...
    def render_sample_data(self, sample_data_token: str, with_anns: bool = True,
        ...
        return self.explorer.render_sample_data(sample_data_token, with_anns, box_vis_level, axes_limit, ax,
                                                nsweeps=nsweeps,
    ...
    def render_scene(self, scene_token: str, freq: float = 10, imwidth: int = 640,
                     out_path: str = None) -> None:
        self.explorer.render_scene(scene_token, freq, imwidth=imwidth, out_path=out_path)
    ...
    def render_scene_channel(self, scene_token: str, channel: str = 'CAM_FRONT', freq: float = 10,
        ...
        self.explorer.render_scene_channel(scene_token=scene_token, channel=channel, freq=freq, imsize=imsize,
                                           out_path=out_path)
...
class NuScenesExplorer:
    ...
    def render_scene(self,
        ...
        :param imwidth: Width of image to render. Height is determined automatically to preserve aspect ratio.
        ...
        imheight = int(imwidth * current_recs[channels[0]]["height"] / current_recs[channels[0]]["width"])
